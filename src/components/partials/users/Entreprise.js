                ...
                <div className="form-info bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-8 flex flex-col">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                          ...
                          <input
                            ...
                            className="appearance-none block w-full focus:bg-gray-200 border border-gray-400 text-gray-700  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Entreprise"
                            />
                        </div>
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                            ...
                            <input 
                             ...
                             className="appearance-none w-full block focus:bg-gray-200 border border-gray-400  text-gray-700  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Adresse"/>
                            </div>
                    </div>
                    </form>
                </div>
